        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-jet-nav-link href="{{ route('addCat') }}" :active="request()->routeIs('addCat')">
                                {{ __('Category') }}
                            </x-jet-nav-link>
                            <x-jet-nav-link href="{{ route('addpro') }}" :active="request()->routeIs('addpro')">
                                {{ __('Product') }}
                            </x-jet-nav-link>
                            <x-jet-nav-link href="{{ route('addpay') }}" :active="request()->routeIs('addpay')">
                                {{ __('Payment Method') }}
                            </x-jet-nav-link>
                            <x-jet-nav-link href="{{ route('order') }}" :active="request()->routeIs('addpay')">
                                {{ __('All Orders') }}
                            </x-jet-nav-link>
                            <x-jet-nav-link href="{{ route('users') }}" :active="request()->routeIs('addpay')">
                                {{ __('All Users') }}
                            </x-jet-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-jet-responsive-nav-link href="{{ route('addCat') }}" :active="request()->routeIs('addCat')">
                        {{ __('Category') }}
                    </x-jet-responsive-nav-link>
                    <x-jet-responsive-nav-link href="{{ route('addpro') }}" :active="request()->routeIs('addpro')">
                        {{ __('Product') }}
                    </x-jet-responsive-nav-link>
                    <x-jet-responsive-nav-link href="{{ route('addpay') }}" :active="request()->routeIs('addpay')">
                        {{ __('Payment Method') }}
                    </x-jet-responsive-nav-link>
                </div>
